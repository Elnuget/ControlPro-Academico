...
“Esta matriz resume el cumplimiento: tres aplicaciones, PostgreSQL, Redis, una función reactiva, RabbitMQ, API Gateway, Swagger, C4, atributos de calidad y CI/CD.”

## 4. Arquitectura general — 55 segundos

“El cliente solo conoce el API Gateway. Project Service es dueño de proyectos y avances. PostgreSQL conserva el estado, Redis acelera lecturas y RabbitMQ recibe los eventos. Alert Function consume esos eventos y crea notificaciones. Hay una ruta síncrona para responder y otra asíncrona para trabajo secundario.”
...
“PostgreSQL entrega consistencia y trazabilidad; Redis usa TTL e invalidación; RabbitMQ conserva mensajes durables y solo recibe confirmación cuando la función terminó de guardar.”
...
“Docker Compose levanta seis contenedores. GitHub Actions instala, ejecuta cuatro pruebas, valida sintaxis y construye imágenes. Los logs son JSON y el Gateway propaga un identificador de petición.”

## 12. Evidencia — 35 segundos

“La prueba integral pasó: cuatro pruebas aprobadas, seis contenedores, cero vulnerabilidades reportadas y HTTP 201. Además se verificó que el evento fue publicado y la función creó la notificación.”
